...
2\.  Click the \*\*Install Script\*\* button at the top of this page, or install it directly from \[GreasyFork](https://greasyfork.org/scripts/TU\_ID\_AQUI).
